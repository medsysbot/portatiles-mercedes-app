...
btnEliminar?.addEventListener('click', async () => {
  ...
  try {
    ...
    await obtenerClientes();  // Esta función ya tiene sus propios alerts
  } catch (err) {
...
async function obtenerClientes() {
  try {
    await showAlert('guardando-datos', 'Cargando clientes...', true, 2600);  // Ícono correcto para carga inicial
