...
async def facturas_pendientes_admin(request: Request):
    ...
    return TEMPLATES.TemplateResponse("facturas_pendientes.html", {"request": request})
...
async def form_nueva_factura(request: Request):
    ...
    return TEMPLATES.TemplateResponse("facturas_pendientes_form.html", {"request": request})
...
async def crear_factura(request: Request):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Error al guardar factura")
